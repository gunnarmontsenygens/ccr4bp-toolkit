function [X_vec, traj, hist] = perp_cross_ccr4bp(X_0_vec, t_star, params, tol, max_iter, t_0, max_step, alpha_min)
%==========================================================================
%
...
%==========================================================================
    ...
    hist.z_vec(:,1) = z_vec;
    hist.X_vec(:,1) = [z_vec(1); 0; 0; z_vec(2)];
    ...
    for k = 1:max_iter
        ...
        while alpha > alpha_min
            ...
            f_trial_vec = C * traj_trial.x_f_vec;
        ...
        hist.X_vec(:,k+1) = [z_vec(1); 0; 0; z_vec(2)];
    end

    %----------------------------------------------------------------------
    % No convergence
    %----------------------------------------------------------------------
    X_vec = [z_vec(1); 0; 0; z_vec(2)];
